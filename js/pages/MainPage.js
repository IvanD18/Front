...
<!--                  <button data-id="view-new" type="button" class="btn btn-secondary btn-lg btn-block">View new</button>-->
              </div>
            </div>
        </div>
      ...
      <div class="modal fade" data-id="notification-modal" tabindex="-1">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div data-id="notification-message" class="modal-body">
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            </div>
              ...
              <button data-id="view-more" type="button" class="btn btn-primary btn-lg btn-block">View more</button>
      
    `;


        this._rootEl.querySelector('[data-id=view-more]').addEventListener('click', evt => {
            this.count += 5;
            evt.preventDefault();
            this._context.get(`/posts/count/${this.count}`);
        });
        ...
        this._notificationModal = $('[data-id=notification-modal]'); // jquery
        this._errorMessageEl = this._rootEl.querySelector('[data-id=error-message]');
        this._notificationMessageEl = this._rootEl.querySelector('[data-id=notification-message]');
